...
public class PromedioClase {
         ...
         static int total = 0; // inicializa la suma de calificaciones introducidas por el usuario
        static int contadorCalificaciones = 1;
    public void entrada (){
        // crea objeto Scanner para obtener la entrada de la ventana de comandos
        Scanner entrada = new Scanner(System.in);
        
        // fase de inicialización
         // inicializa # de calificación a introducir a continuación
